 ...
 */
final class Version20241005085406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_23A0E6629A33219 ON article');
        $this->addSql('ALTER TABLE article DROP material_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD material_id_id INT DEFAULT NULL');
        $this->addSql('CREATE INDEX IDX_23A0E6629A33219 ON article (material_id_id)');
