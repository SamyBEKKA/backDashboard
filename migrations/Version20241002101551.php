 ...
 */
final class Version20241002101551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD paiement_id_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_F5299398D7DC7B48 ON `order` (paiement_id_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F5299398D7DC7B48 ON `order`');
        $this->addSql('ALTER TABLE `order` DROP paiement_id_id');
