 ...
 */
final class Version20241006182451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD order_total_price DOUBLE PRECISION DEFAULT NULL, DROP use_existing_items');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD use_existing_items TINYINT(1) DEFAULT NULL, DROP order_total_price');
