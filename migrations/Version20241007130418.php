 ...
 */
final class Version20241007130418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item CHANGE nombres_articles nombres_articles SMALLINT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item CHANGE nombres_articles nombres_articles SMALLINT NOT NULL');
