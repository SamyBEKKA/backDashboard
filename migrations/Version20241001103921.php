 ...
 */
final class Version20241001103921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD CONSTRAINT FK_23A0E6629A33219 FOREIGN KEY (material_id_id) REFERENCES material (id)');
        $this->addSql('ALTER TABLE city ADD CONSTRAINT FK_2D5B0234D8A48BBD FOREIGN KEY (country_id_id) REFERENCES country (id)');
        $this->addSql('ALTER TABLE employe DROP employe_name, DROP employe_last_name, DROP employe_password, DROP employe_roles, DROP user_email, CHANGE id id INT NOT NULL');
        ...
        $this->addSql('DROP INDEX ID_USERNAME ON user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP FOREIGN KEY FK_23A0E6629A33219');
        ...
        $this->addSql('ALTER TABLE employe ADD employe_name VARCHAR(255) NOT NULL, ADD employe_last_name VARCHAR(255) NOT NULL, ADD employe_password VARCHAR(255) NOT NULL, ADD employe_roles JSON NOT NULL, ADD user_email VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX ID_USERNAME ON `user` (user_email)');
    }
}
