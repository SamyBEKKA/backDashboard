 ...
 */
final class Version20241007131045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item CHANGE total_price total_price DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item CHANGE total_price total_price DOUBLE PRECISION NOT NULL');
